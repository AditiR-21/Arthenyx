...
Backend: Uses predefined narrative inputs and simulates APIs for cloud scaling and vendor consolidation.

Frontend: Uses stochastic simulation for NFI trends and cost predictions.
